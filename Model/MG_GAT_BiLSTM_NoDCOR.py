...
# -*- coding: utf-8 -*-
"""
MG-GAT-BiLSTM Model (Ablation: No dCor Graph)

This module implements the MG-GAT-BiLSTM model without dCor graph.
The model uses two graph branches (MIC, Spearman) and Global Attention + BiLSTM for temporal modeling.
"""
...
class MG_GAT_BiLSTM_NoDCOR(nn.Module):
    """
    Multi-Graph GAT-BiLSTM Model (Ablation: No dCor Graph)
    
    This model uses two graph branches (MIC, Spearman) for multi-graph fusion,
